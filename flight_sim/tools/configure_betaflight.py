        ...
        try:
            ...
            with conn:
                ...
                commands = [
                    ...
                    'set dterm_lpf1_static_hz = 30', 'set dterm_lpf2_static_hz = 50',
                    'set dterm_lpf1_dyn_min_hz = 0',
                    # This plant has a linear steady command/thrust map. Do
                    # not silently remove damping at high collective or vary
                    ...
                    # Steady sensor timing and D provide damping. Avoid a
                    # request slew limit that can swallow rapid reversals.
                    'set acc_limit = 0', 'set acc_limit_yaw = 0',
                    'set anti_gravity_gain = 0', 'set anti_gravity_p_gain = 0',
                    'set throttle_boost = 0',
                    # USB input already has a calibrated deadband. Do not
                    # add another adaptive filter to the pilot's commands.
                    # Keep the v6 stick curve while fixing controller tracking.
