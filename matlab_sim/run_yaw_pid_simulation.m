%% Yaw view of the programmed 6DOF maneuver (body z / Mz)
...
yawSimulation = extractDrone6DOFAxisResponse(full6DOFSimulation, 'Yaw');
if ~exist('showYawAxisPlot', 'var') || showYawAxisPlot
